    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
            ...
            <li><i class="fa fa-file-text-o"></i>Editar PLAMENS</li>
        </ol>
      </div>
      <span class="success" style="color:green; margin-top:10px; margin-bottom: 10px;"></span>
<form action="{!! route('education-form.update', $education_form->id) !!}" method = "post" name="education-form" id="education-form">
	{{ method_field('PUT') }}
  <div class="row">
    <div class="col-lg-12">
      <section class="panel">
          ...
          <div class="col-md-12">
            <div class="form-group">
              <div class="col-md-12" align="center">          
                <input type="radio" name="plan" id="plan" value="PLAMENS BR"  {{$education_form->plan == "PLAMENS BR" ? 'checked' : ''}}>
                 PLAMENS BR                                
                <input type="radio" name="plan" id="plan" value="PLAMENS EXT"  {{$education_form->plan == "PLAMENS EXT" ? 'checked' : '' }}>
                 PLAMENS EXT
              </div>         
            </div>
          </div>
    ...
    <div class="col-md-12">
      <section class="panel">
        ...
        <div class="panel-body">
        	{{-- @foreach($education_form as $education_form) --}}
          <div class="col-md-12">
            <div class="form-group">
              <label class="col-md-2 control-label">N° DA MISSÃO PROPOSTA</label>
                <div class="col-md-4">
                  <input type="text" class="form-control" style="text-transform:uppercase" maxlength="2" id="" name="mission_number" value= "{{old('mission_number', $education_form->mission_number)}}">
                </div>
              <label class="col-md-2 control-label">ANO DO INÍCIO DA MISSÃO</label>  
                <div class="col-md-4">
                  <input type="text" class="form-control" style="text-transform:uppercase" maxlength="4" name="start_year" value="{{old('start_year', $education_form->start_year)}}">
                </div>          
            </div>
          </div>
          {{-- @endforeach --}}
            ...
            <div class="form-group">
              <label class="col-md-2 control-label">TRILHA DE CAPACITAÇÃO</label>
                <div class="col-md-10" align="center">          
                  <input type="radio" name="training_track" id="training_track" value="CP" {{$education_form->training_track == "CP" ? 'checked' : ''}}>
                   CAPITÃO                                
                  <input type="radio" name="training_track" id="training_track" value="MJ" {{$education_form->training_track == "MJ" ? 'checked' : ''}}>
                   MAJOR
                  <input type="radio" name="training_track" id="training_track" value="TC" {{$education_form->training_track == "TC" ? 'checked' : ''}}>
                   TENENTE CORONEL
                </div>         
            </div>
          </div>
              ...
              <div class="col-md-12">
                <div class="panel-body">
                    <div class="form-group">
                      ...
                      <div class="col-md-10">
                        <input type="text" class="form-control" style="text-transform:uppercase" name="title" value= "{{old('title', $education_form->title)}}">
                      </div>
                    </div>                                        
                </div>
              </div>
              ...
              <div class="col-md-12">
                <div class="panel-body">
                    <div class="form-group">
                      ...
                      <div class="col-md-10">
                        <input type="text" class="form-control" style="text-transform:uppercase" name="establishment" value= "{{old('establishment', $education_form->establishment)}}">
                      </div>
                    </div>                                        
                </div>
              </div>
              ...
              <div class="col-md-12">
                <div class="panel-body">
                    <div class="form-group">
                      ...
                      <div class="col-md-3">
                        <input type="text" class="form-control" style="text-transform:uppercase" name="city" value= "{{old('city', $education_form->city)}}" >
                      </div>
                      <label class="col-md-1 control-label">Estado</label>
                      <div class="col-md-3">
                        <input type="text" class="form-control" style="text-transform:uppercase" name="state" value= "{{old('state', $education_form->state)}}" >
                      </div>
                      <label class="col-md-1 control-label">País</label>
                      <div class="col-md-3">
                        <input type="text" class="form-control" style="text-transform:uppercase" name="country" value= "{{old('country', $education_form->country)}}" >
                      </div>
                    </div>                                        
                </div>
              </div>
                        ...
                        <div class="row">
                          <div class="col-md-3">
                            <div class="input-group date" id="dateline_start">
                              ...
                              <input class="set-due-date form-control" id="dateline_start" name="dateline_start" type="date" value= "{{old('dateline_start', $education_form->dateline_start)}}" />
                            </div>
                          </div>
                          <div class="col-md-3">
                            <div class="input-group date" id="dateline_finish">
                              ...
                              <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                              <input class="set-due-date form-control" id="dateline_finish" name="dateline_finish" type="date" value= "{{old('dateline_finish', $education_form->dateline_finish)}}" />
                            </div>
                          </div>
                        </div>
                    </div>                                        
              ...
              <div class="col-md-12">
                <div class="panel-body">
                    <div class="form-group">
                      ...
                      <div class="col-md-4">
                        <input type="text" class="form-control" style="text-transform:uppercase" name="duration" value= "{{old('duration', $education_form->duration)}}">
                      </div>
                      <label class="col-md-3 control-label">Carga Horária Total (em horas)</label>
                      <div class="col-md-3">
                        <input type="text" class="form-control" name="workload" value= "{{old('workload', $education_form->workload)}}">
                      </div>
                    </div>                                        
                </div>
              </div>
              ...
              <div class="col-md-12">
                <div class="panel-body">
                    <div class="form-group">
                      ...
                      <div class="col-md-9">
                        <input type="text" class="form-control" style="text-transform:uppercase" name="research_line" value= "{{old('research_line', $education_form_details->research_line)}}">
                      </div>
                    </div>                                        
                </div>
              </div>
              ...
              <div class="form-group">
                <label class="col-md-3 control-label">Existe Curso / Estágio similar no Brasil?</label>
                  <div class="col-md-9" align="left">          
                    <input type="radio" name="similar_course" id="similar_course" value=1 {{$education_form_details->similar_course == "1" ? 'checked' : ''}} >
                     SIM                                
                    <input type="radio" name="similar_course" id="similar_course" value=0 {{$education_form_details->similar_course == "0" ? 'checked' : ''}} >
                     NÃO
                  </div>
                  <div class="col-md-12">
                    <input type="text" class="institution_similar_course" style="text-transform:uppercase" name="institution_similar_course" value= "{{old('institution_similar_course', $education_form_details->institution_similar_course)}}">
                  </div>         
              </div>
            </div>
          </div>
      ...
      <div class="col-lg-12">
        <section class="panel">
          ...
          <div class="col-md-12">
            <div class="form-group">
                <div class="col-md-12" align="center">          
                  <input type="radio" name="importance" id="importance" value="IMPRESCINDÍVEL" {{$education_form_details->importance == "IMPRESCINDÍVEL" ? 'checked' : ''}} >
                   IMPRESCINDÍVEL                                
                  <input type="radio" name="importance" id="importance" value="NECESSÁRIO" {{$education_form_details->importance == "NECESSÁRIO" ? 'checked' : ''}} >
                   NECESSÁRIO
                  <input type="radio" name="importance" id="importance" value="DESEJÁVEL" {{$education_form_details->importance == "DESEJÁVEL" ? 'checked' : ''}} >
                   DESEJÁVEL
                </div>         
            </div>
              ...
              <div class="col-md-12">
                <div class="panel-body">
                    <div class="form-group">
                      ...
                      <div class="col-md-10">
                        <input type="text" class="form-control" style="text-transform:uppercase" name="designated" value= "{{old('designated', $education_form_details->designated)}}" >
                      </div>
                    </div>                                        
                </div>
              </div>
              ...
              <div class="col-md-12">
                <div class="panel-body">
                    <div class="form-group">
                      ...
                      <div class="col-md-10">
                        <input type="text" maxlength="2" class="form-control" style="text-transform:uppercase" name="vacancies_requested" value= "{{old('vacancies_requested', $education_form_details->vacancies_requested)}}" >
                      </div>
                    </div>                                        
                </div>
              </div>
              ...
              <div class="col-md-12">
                <div class="panel-body">
                    <div class="form-group">
                      ...
                      <div class="col-md-10">
                        <input type="text" class="form-control" style="text-transform:uppercase" name="prerequisites" value= "{{ old('prerequisites', $education_form_details->prerequisites)  }}" >
                      </div>
                    </div>                                        
                </div>
              </div>
              ...
              <div class="col-md-12">
                <div class="panel-body">
                    <div class="form-group">
                      ...
                      <div class="col-md-10">
                        <input type="text" class="form-control" style="text-transform:uppercase" name="destination_after_course" value= "{{ old('destination_after_course', $education_form_details->destination_after_course)  }}">
                      </div>
                    </div>                                        
                </div>
              </div>
              ...
              <div class="col-md-12">
                <div class="panel-body">
                    <div class="form-group">
                      ...
                      <div class="col-md-10">
                        <input type="text" class="form-control" style="text-transform:uppercase" name="function_after_course" value= "{{ old('function_after_course', $education_form_details->function_after_course)  }}">
                      </div>
                    </div>                                        
                </div>
              </div>
              ...
              <div class="col-md-12">
                <div class="panel-body">
                    <div class="form-group">
                      ...
                      <div class="col-md-10">
                        <input type="text" class="form-control" style="text-transform:uppercase" name="desired_training" value= "{{ old('desired_training', $education_form_details->desired_training)  }}" >
                      </div>
                    </div>                                        
                </div>
              </div>
              ...
              <div class="col-md-12">
                <div class="panel-body">
                    <div class="form-group">
                      ...
                      <div class="col-md-10">
                        <input type="text" class="form-control" style="text-transform:uppercase" name="pac" value= "{{ old('pac', $education_form_details->pac)  }}" >
                      </div>
                    </div>                                        
                </div>
              </div>
          ...
          <header class="panel-heading">
           CAMPO VIII - CARACTERIZAÇÃO DA PROPOSTA
            ...
            <h4 style='text-align:left; vertical-align:middle'>Impacto</h4>    
              <input type="radio" name="impact" id="impact" value="5" {{$education_form_features->impact == '5' ? 'checked' : ''}}>
               A não realização gera grandes perdas para o COMAER 
               <br>       
              <input type="radio" name="impact" id="impact" value="4" {{$education_form_features->impact == '4' ? 'checked' : ''}}>
               A não realização gera perdas significativas para o COMAER
               <br>       
              <input type="radio" name="impact" id="impact" value="3" {{$education_form_features->impact == '3' ? 'checked' : ''}}>
               A não realização gera perdas para o COMAER
               <br>       
              <input type="radio" name="impact" id="impact" value="2" {{$education_form_features->impact == '2' ? 'checked' : ''}}>
               A não realização gera poucas perdas para o COMAER
               <br>       
              <input type="radio" name="impact" id="impact" value="1" {{$education_form_features->impact == '1' ? 'checked' : ''}}>
            ...
            <h4 style='text-align:left; vertical-align:middle'>Tipo de Missão</h4>    
              ...
              <input type="radio" name="mission_type" id="mission_type" value="3" unchecked>
               Com compromissos contratuais/offset assumidos e o não cumprimento pode acarretar prejuízos ao COMAER.
               <br>       
    ...
    <script> //Função para campo dinâmico de missões anteriores
      $(document).ready(function(){
        ...
        function previous_mission(number)
        {
          ...
          html += '<td>  <input type="text" maxlength="2" name="of_gd[]" class="form-control" style="text-transform:uppercase" value="{{ old('of_gd') ?? $education_form_previous->of_gd }}" /></td>';
          html += '<td>  <input type="text" maxlength="100" name="name[]" class="form-control" style="text-transform:uppercase" value="{{ old('name') ?? $education_form_previous->name }}"  /></td>';
          html += '<td>  <input type="text" maxlength="20" name="om[]" class="form-control" style="text-transform:uppercase" value="{{ old('om') ?? $education_form_previous->om }}" /></td>';
          html += '<td>  <input type="text" maxlength="20" name="current_function[]" class="form-control" style="text-transform:uppercase" value="{{ old('current_function') ?? $education_form_previous->current_function }}" id = "Totmarks1"/></td>';
    ...
    <script> //Função para campo dinâmico da parte financeira
      $(document).ready(function(){
        ...
        function education_finance(number)
        {
          ...
          html += '<td> <input type="number" step = ".01" name="cost_help[]" class="form-control" value="{{ old('cost_help') ?? $education_form_finance->cost_help }}" /></td>';
          html += '<td> <input type="number" step = ".01" name="salary[]" class="form-control" value="{{ old('salary') ?? $education_form_finance->salary }}" /></td>';
          html += '<td> <input type="number" step = ".01" name="housing_assistance[]" class="form-control" value="{{ old('housing_assistance') ?? $education_form_finance->housing_assistance }}" /></td>';
          html += '<td> <input type="number" step = ".01" name="baggage_transport[]" class="form-control" value="{{ old('baggage_transport') ?? $education_form_finance->baggage_transport }}" /></td>';
          html += '<td> <input type="number" step = ".01" name="daily[]" class="form-control" value="{{ old('daily') ?? $education_form_finance->daily }}" /></td>';
          html += '<td> <input type="number" step = ".01" name="personal_transport_1[]" class="form-control" value="{{ old('personal_transport_1') ?? $education_form_finance->personal_transport_1 }}" /></td>';
          html += '<td> <input type="number" step = ".01" name="personal_transport_2[]" class="form-control" value="{{ old('personal_transport_2') ?? $education_form_finance->personal_transport_2 }}" /></td>';
          html += '<td> <input type="number" step = ".01" name="course_cost[]" class="form-control" value="{{ old('course_cost') ?? $education_form_finance->course_cost }}" /></td>';
          html += '<td> <input type="number" step = ".01" name="total_annual[]" class="form-control" value="{{ old('total_annual') ?? $education_form_finance->total_annual }}" /></td>';
          html += '<td> <input type="number" step = ".01" name="course_year[]" class="form-control" value="{{ old('course_year') ?? $education_form_finance->course_year }}" id = "Totmarks" /></td>';
