  ...
  <div class="row">
    ...
    <div class="row">
      <div class="col-lg-12">
        <section class="panel">
          ...
          <div class="panel-body"> 
              @csrf
              <textarea id="goals" style="text-transform:uppercase" name="goals"></textarea>
          </div>
          <header class="panel-heading">
          ...
          <div class="panel-body"> 
              @csrf
              <textarea id="subject_description" style="text-transform:uppercase" name="subject_description"></textarea>
          </div>
          <div class="row">
              <div class="col-md-12">
                <div class="panel-body">
      ...
      <div class="col-lg-12">
        <section class="panel">
          ...
          <div class="col-md-12">
            ...
            <div class="panel-body"> 
              @csrf
              <textarea id="justification" style="text-transform:uppercase" name="justification"></textarea>
            </div>
          </div>                  
        </section>
      </div>
    ...
    <div class="row">
        <div class="col-lg-12">
          ...
          <div class="panel-body"> 
              @csrf
              <textarea id="detailed_justification" style="text-transform:uppercase" name="detailed_justification"></textarea>
          </div>
        </div>
    </div>
