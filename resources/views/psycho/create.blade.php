...
<section id="main-content">
    <section class="wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header"><i class="fa fa-file-text-o"></i> SRH </h3>
                <ol class="breadcrumb">
                    <li><i class="fa fa-home"></i><a href="/dashboard">Início</a></li>
                    <li><i class="icon_document_alt"></i>Análises Psicológicas</li>
                    <li><i class="fa fa-file-text-o"></i>Adicionar Análise Psicológica</li>
                </ol>
            </div>
        </div>
        <div class="row">
                ...
                <section class="panel">
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-8">
                                <div class="card">
                                	{!! Form::open(array('route' => 'psycho.store', 'files' => true)) !!}
                                        ...
                                        {{ Form::label('featured_file', 'Adicionar Análise Psicológica:') }}
                                        {{ form::file('featured_file') }}

                                		{{ Form::submit('Adicionar Análise Psicológica', array('class' => 'btn btn-success btn-lg btn-block', 'style' => 'margin-top 20px')) }}
                                	{!! Form::close()!!}
                                </div>
                            </div>
                        </div>
