  ...
  <div class="row">
    ...
    <div class="row">
        <div class="col-lg-12">
          ...
          <div class="panel-body"> 
              @csrf
              <textarea class="form-input form-text" id="justifications" style="text-transform:uppercase" name="justifications">
    ...
    <div class="row">
        <div class="col-lg-12">
          ...
          <div class="panel-body"> 
              @csrf
              <textarea class="form-input form-text" id="observations" style="text-transform:uppercase" name="observations">
